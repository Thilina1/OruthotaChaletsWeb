...
function ChaletBookingComponent() {
    ...
    const handleSubmit = async ()=>{
        ...
        if (email && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$contact$2d$validation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidEmail"])(email)) {
            toast({
                variant: 'destructive',
                title: 'Invalid email',
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$contact$2d$validation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidInternationalPhone"])(form.customer_phone)) {
            toast({
                variant: 'destructive',
...
//# sourceMappingURL=src_ed2609db._.js.map