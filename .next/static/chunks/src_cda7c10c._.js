            ...
            return rooms.map({
                "BookingsListComponent.useMemo[processedRooms]": (room)=>{
                    const roomReservations = (reservations || []).filter({
                        "BookingsListComponent.useMemo[processedRooms].roomReservations": (res)=>res.roomId === room.id && res.status === 'confirmed'
                        ...
                        "BookingsListComponent.useMemo[processedRooms].roomReservations": (res)=>{
                            ...
                            const checkInDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(res.checkInDate + 'T00:00:00Z');
                            const checkOutDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(res.checkOutDate + 'T00:00:00Z');
                            return {
                                start: checkInDate,
                                end: checkOutDate
                            };
...
//# sourceMappingURL=src_cda7c10c._.js.map