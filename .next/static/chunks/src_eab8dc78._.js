...
function PhoneNumberInput(param) {
    ...
    const selected = (_COUNTRY_CODES_find = COUNTRY_CODES.find((param)=>{
        let { code } = param;
        return value.startsWith(code);
    })) !== null && _COUNTRY_CODES_find !== void 0 ? _COUNTRY_CODES_find : COUNTRY_CODES[0];
    ...
    const updateNumber = (countryCode, digits)=>{
        onChange("".concat(countryCode).concat(digits.replace(/\D/g, '').replace(/^0+/, '').slice(0, 14)));
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                ...
                children: COUNTRY_CODES.map((param)=>{
                    let { code, country, flag } = param;
                    ...
                    }, "".concat(country, "-").concat(code), true, {
...
"[project]/src/app/booking/booking-component.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BookingPageComponent() {
    ...
    const [idCardNumber, setIdCardNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [checkOutDate, setCheckOutDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "BookingPageComponent.useState": ()=>{
            ...
            const cin = searchParams.get('checkIn');
            const cinDate = cin ? new Date(cin) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(today, 1);
            try {
                if (cout && new Date(cout) > cinDate) return new Date(cout);
            } catch (e) {}
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(cinDate, 1);
        }
    }["BookingPageComponent.useState"]);
    const adults = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookingPageComponent.useMemo[adults]": ()=>parseInt(searchParams.get('adults') || '2')
    }["BookingPageComponent.useMemo[adults]"], [
        searchParams
    ]);
    const children = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookingPageComponent.useMemo[children]": ()=>parseInt(searchParams.get('children') || '0')
    }["BookingPageComponent.useMemo[children]"], [
        searchParams
    ]);
    const numberOfGuests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookingPageComponent.useMemo[numberOfGuests]": ()=>adults + children
    }["BookingPageComponent.useMemo[numberOfGuests]"], [
        adults,
        children
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BookingPageComponent.useEffect": ()=>{
            async function fetchRoom() {
                if (!roomId) return;
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('rooms').select('*').eq('id', roomId).single();
                if (data) {
                    setRoom(data);
                }
                if (error) {
    ...
    const numberOfNights = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookingPageComponent.useMemo[numberOfNights]": ()=>{
            if (checkInDate && checkOutDate && checkOutDate > checkInDate) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInCalendarDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["differenceInCalendarDays"])(checkOutDate, checkInDate);
            }
            return 0;
        }
    }["BookingPageComponent.useMemo[numberOfNights]"], [
    ...
    const totalCost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookingPageComponent.useMemo[totalCost]": ()=>{
    ...
    const handleBooking = async (e)=>{
        ...
        try {
            ...
            const { data: guest, error: guestError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('guests').upsert([
                guestData
            ], {
                onConflict: 'email'
            ...
            const reservationData = {
                ...
                guest_name: "".concat(firstName, " ").concat(lastName),
                guest_email: email,
                check_in_date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(checkInDate, 'yyyy-MM-dd'),
                check_out_date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(checkOutDate, 'yyyy-MM-dd'),
            ...
            const { error: reservationError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('reservations').insert([
                reservationData
            ]);
...
_s(BookingPageComponent, "S/Msp5mHrUs4qu05mwY/AvXGuJk=", false, function() {
    return [
...
_c = BookingPageComponent;
var _c;
__turbopack_context__.k.register(_c, "BookingPageComponent");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$booking$2f$booking$2d$component$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/booking/booking-component.tsx [app-client] (ecmascript)");
'use client';
;
;
;
function BookingPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$booking$2f$booking$2d$component$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
            fileName: "[project]/src/app/booking/page.tsx",
            lineNumber: 9,
            columnNumber: 7
        }, this)
...
//# sourceMappingURL=src_eab8dc78._.js.map